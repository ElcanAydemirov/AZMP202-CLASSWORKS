// function printFullName(firstName = "Eljan", lastName = "Aydamirov") {
...
//     }
//     else {
//         return "ne 5e ne 3e nede 2e bolunmur"
//     }
// }
...
// console.log(reverse([1, 2, 3, 45, 6]));
...
//         return "kecmedi";
//     } else {
//         return "bali sehv daxil etmisiniz bal 0 ile 100 arasinda ola biler"
//     }
// }
...
// console.log(checkmax([1, 2, 3, 4, 5, 6, 45, 2, 3, 6]));
...
// function sesli(letter) {
//     let tolowering = letter.toLowerCase();
//     switch (tolowering) {
//         case "e":
//             return "seslidi";
//             break;
...
function ratingcount(products) {
    for (let i = 0; i < products.length; i++)
        if (products[i].ratingcount < 120) {
            console.log(products[i]);

        }
}

ratingcount(products)