...
// });
// //task 2
// const milksfind = milks.find((item) => {
//     return item.id === 1;
// });
// console.log(milksfind);
// //task 3
// const fatAverage = milks.reduce((sum, item) => {
//     return sum += item.FatPercent, 0;
// });
// console.log(fatAverage);
// //task 4 
// const yagliliq = milks.filter((item) => {
//     return item.FatPercent > 3;
// });
// console.log(yagliliq);
// //task 5
// function plus(arr, num) {
//     return arr.map(item => item + num);
// }
// console.log(plus(milks, 10));
// //task 6
// const prices = milks.reduce((sum, item) => {
//     return sum += item.price, 0;
// });
// console.log(prices);


// // const FatAverage = milks.reduce((sum, item) => { return sum + item.FatPercent }, 0)
// // const average = FatAverage / milks.length;

// // console.log(average.toFixed(2));

// //task 7
// const filtered = milks.filter((item) => {
//     return item.id === 2;
// })
// console.log(filtered);

// //task 8
// const theExpensive = milks.filter 

// //Task9
// const minus = milks.filter(item) => {
...
// //task 3
// const filteringman = products.filter((item) => {
//     return item.category === "men";
// })

// console.log(filteringman);
...
// // task 5
// const titlesorting = products.sort((a, b) => {
//     return b.title.localeCompare(a.title);
// })
// console.log(titlesorting);
// //task 6
// const checking = products.every((item) => {
//     return item.count > 100;
// });
// //task 7
// const cat = products.filter((item) => {
